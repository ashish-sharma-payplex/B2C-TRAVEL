...
// ─── Validation — passport/PAN are now conditional ───────────────────────────
const validateTraveller = (type, data, opts = {}) => {
  const { requiresPassport = false, requiresPan = false } = opts;
  const errs = {};
...
export default function BookFlight() {
  ...
  // ── fareQuote se passport/PAN requirement nikalo ──────────────────────────
  // Book ke time wale flags use karo (AtBook)
  // Agar onward ya return me se koi bhi true hai toh show karo
  ...
  // Ticket ke time wale flags (aage kaam ayenge, state me pass karenge)
  ...
  // Overall: agar book ya ticket me se kisi me bhi chahiye toh form me dikhao
  const requiresPassport = requiresPassportAtBook || requiresPassportAtTicket;
  ...
  const handleProceed = () => {
    ...
    navigate("/ssr", {
      state: {
        ...
        // Ticket time passport/PAN requirement bhi pass karo
      ...
      <div className="bk-wrap">
        <div className="bk-grid">
          <div>
            ...
            {/* ── Contact Information ── */}
            {/* NOTE: Yahan SIRF contact info hai.
                Passenger cards me se email/mobile hata diye hain.
                Booking/ticket payload me contact.mobile aur contact.email use hoga. */}
            <div className="card">
