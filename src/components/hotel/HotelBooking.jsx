...
import BestDealHotels from "../components/BestDealHotels";
...
const HotelBooking = ({ scrolled }) => {
  ...
  const [guestsLabel, setGuestsLabel] = useState("1 Room, 2 Adults");
