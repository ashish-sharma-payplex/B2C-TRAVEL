...
//                   }}
//                 />
//                 <Typography sx={{ fontSize: 20, lineHeight: 1, display: "none" }}>
//                   {cat.emoji}
//                 </Typography>
//                 <Typography
//                   sx={{
...
//             <LuggageOutlinedIcon sx={{ fontSize: 20, color: "#555" }} />
//             <Box>
//               <Typography sx={{ fontSize: 10, color: GREEN, fontWeight: 600, lineHeight: 1, mb: 0.2 }}>
//                 Manage Booking
//               </Typography>
//               <Typography sx={{ fontSize: 13, fontWeight: 500, color: "#333", lineHeight: 1 }}>
//                 My Trips
//               </Typography>
//             </Box>
//           </Box>
...
// // ─── renderFields ─────────────────────────────
// function renderFields(FIELDS, calendarOpen, activeField, guestsOpen, locationOpen) {
//   return FIELDS.map((field, index) => {
//     const isActive =
//       (calendarOpen &&
//         ((field.id === "checkin" && activeField === "checkin") ||
...
//           cursor: "pointer",
//           borderRight: {
//             md: index < FIELDS.length - 1 ? `1.5px solid ${hasError ? "#fecaca" : BORDER}` : "none",
//             xs: "none",
//           },
//           borderBottom: {
//             xs: `1.5px solid ${hasError ? "#fecaca" : BORDER}`,
...
//   const [checkIn, setCheckIn] = useState(null);
//   const [checkOut, setCheckOut] = useState(null);
//   const [errors, setErrors] = useState({ location: "", checkin: "", checkout: "" });
...
//   // ✅ KEY CHANGE: calendarAnchor काढला, फक्त activeField set करतो
//   const openCalendar = (field) => {
//     if (calendarOpen && activeField === field) {
//       // same field वर click केला तर बंद करा
...
//     if (!selectedCity.code) { newErrors.location = "Please select a location"; hasError = true; }
//     if (!checkIn) { newErrors.checkin = "Please select a check-in date"; hasError = true; }
//     if (!checkOut) { newErrors.checkout = "Please select a check-out date"; hasError = true; }
//     if (!guestsLabel) { newErrors.guests = "Please select rooms & guests"; hasError = true; }
...
//       if (total > 0) {
//         toast.success(`🏨 ${total} hotels found in ${selectedCity.name.split(",")[0]}!`, {
//           duration: 3000,
//           style: { fontWeight: 600 },
//         });
//       } else {
...
//       isPlaceholder: !selectedCity.code,
//       error: errors.location,
//       icon: <LocationOnIcon sx={{ color: errors.location ? "#dc2626" : GREEN, fontSize: 19 }} />,
//       ref: locationRef,
//       onClick: () => setLocationOpen((o) => !o),
//     },
//     {
...
//       isPlaceholder: !checkIn,
//       error: errors.checkin,
//       icon: <CalendarTodayIcon sx={{ color: errors.checkin ? "#dc2626" : GREEN, fontSize: 19 }} />,
//       ref: checkinRef,
//       onClick: () => openCalendar("checkin"),
//     },
//     {
...
//       isPlaceholder: !checkOut,
//       error: errors.checkout,
//       icon: <CalendarTodayIcon sx={{ color: errors.checkout ? "#dc2626" : GREEN, fontSize: 19 }} />,
//       ref: checkoutRef,
//       onClick: () => openCalendar("checkout"),
//     },
//     {
...
//       isPlaceholder: !guestsLabel,
//       error: errors.guests,
//       icon: <PeopleAltIcon sx={{ color: errors.guests ? "#dc2626" : GREEN, fontSize: 19 }} />,
//       ref: guestsRef,
//       onClick: () => setGuestsOpen((o) => !o),
//     },
//   ];

//   // ✅ Calendar left position — field च्या offsetLeft वरून
//   const getCalendarLeft = () => {
//     if (activeField === "checkin" && checkinRef.current) {
//       return checkinRef.current.offsetLeft;
//     }
//     if (activeField === "checkout" && checkoutRef.current) {
//       return checkoutRef.current.offsetLeft;
//     }
//     return 0;
//   };
...
//             zIndex: 1,
//             backgroundColor: "#fff",
//             // ✅ overflow visible ठेवा — calendar आत दिसण्यासाठी
//             overflow: "visible",
//           }}
//         >
//           {/* HEADER */}
...
//           {/* ✅ SEARCH BOX WRAPPER — position: relative यामुळे calendar आतच राहतो */}
...
//               }}
//             >
//               {renderFields(FIELDS, calendarOpen, activeField, guestsOpen, locationOpen)}
...
//             {/* ✅ CHECK IN CALENDAR — checkin field च्या खाली */}
...
//                   open={true}
//                   onClose={() => { setCalendarOpen(false); setActiveField(null); }}
//                   startDate={checkIn}
//                   endDate={checkOut}
//                   onChange={handleDateChange}
//                   activeField={activeField}
...
//             {/* ✅ CHECK OUT CALENDAR — checkout field च्या खाली */}
...
//       {/* ✅ LocationDropdown — बाहेरच ठेवला, तो anchorEl वापरतो */}
//       <LocationDropdown
//         open={locationOpen}
//         onClose={() => setLocationOpen(false)}
//         anchorEl={locationRef.current}
...
//       {/* ✅ RoomsGuestDropdown — बाहेरच ठेवला */}
//       <RoomsGuestDropdown
//         open={guestsOpen}
//         onClose={() => setGuestsOpen(false)}
//         anchorEl={guestsRef.current}
